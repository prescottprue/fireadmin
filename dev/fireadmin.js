  ...
  */
  ...
  goog.provide('$fa.auth');
  goog.provide('$fa.account');
   ...
   * @export
   */
  $fa.account = angular.module('session.account',[])
  ...
  $fa.auth = angular.module('auth', [$fa.account.name])
  /**
   * Module.
   */
  angular.module('fireadmin', [$fa.auth.name]);
