  ...
  _createClass(Fireadmin, [{
    ...
    value: function emailAuth(loginData) {
      ...
      return this.ref.authWithPassword(loginData, function (error, authData) {
        if (error === null) {
          ...
          _utilsLogger2['default'].log('User ID: ' + authData.uid + ', Provider: ' + authData.provider);
          // Manage presence
    ...
    value: function accountByUid(uid) {
      return this.ref.child(uid).on('value', function (accountSnap) {
        ...
        _utilsLogger2['default'].error('Error getting account for ' + uid + ' : ', err);
        return Promise.reject(err);
      });
    }
...
},{"./config":2,"./utils/logger":4,"lodash":1}],4:[function(require,module,exports){
Object.defineProperty(exports, '__esModule', {
	value: true
});
