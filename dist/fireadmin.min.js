...
goog.functions.cacheReturnValue=function(a){var b=!1,c;return function(){if(!goog.functions.CACHE_RETURN_VALUE)return a();b||(c=a(),b=!0);return c}};goog.i18n={};goog.i18n.bidi={};goog.i18n.bidi.FORCE_RTL=!1;
...
goog.debug.LogBuffer.prototype.clear=function(){this.buffer_=Array(goog.debug.LogBuffer.CAPACITY);this.curIndex_=-1;this.isFull_=!1};goog.debug.LogBuffer.prototype.forEachRecord=function(a){var b=this.buffer_;if(b[0]){var c=this.curIndex_,d=this.isFull_?c:-1;do d=(d+1)%goog.debug.LogBuffer.CAPACITY,a(b[d]);while(d!=c)}};goog.events.ListenerMap=function(a){this.src=a;this.listeners={};this.typeCount_=0};goog.events.ListenerMap.prototype.getTypeCount=function(){return this.typeCount_};goog.events.ListenerMap.prototype.getListenerCount=function(){var a=0,b;for(b in this.listeners)a+=this.listeners[b].length;return a};
...
document.createElement("script");b.onreadystatechange=function(){b.onreadystatechange=null;b.parentNode.removeChild(b);b=null;a();a=null};document.documentElement.appendChild(b)}:function(a){goog.global.setTimeout(a,0)}};goog.async.nextTick.wrapCallback_=goog.functions.identity;goog.debug.entryPointRegistry.register(function(a){goog.async.nextTick.wrapCallback_=a});goog.labs.userAgent.engine={};goog.labs.userAgent.engine.isPresto=function(){return goog.labs.userAgent.util.matchUserAgent("Presto")};goog.labs.userAgent.engine.isTrident=function(){return goog.labs.userAgent.util.matchUserAgent("Trident")||goog.labs.userAgent.util.matchUserAgent("MSIE")};goog.labs.userAgent.engine.isWebKit=function(){return goog.labs.userAgent.util.matchUserAgentIgnoreCase("WebKit")};
...
goog.iter.combinationsWithReplacement=function(a,b){function c(a){return d[a]}var d=goog.iter.toArray(a),e=goog.array.range(d.length),e=goog.array.repeat(e,b),e=goog.iter.product.apply(void 0,e),f=goog.iter.filter(e,function(a){return goog.array.isSorted(a)}),e=new goog.iter.Iterator;e.next=function(){return goog.array.map(f.next(),c)};return e};goog.net.XmlHttp=function(){return goog.net.XmlHttp.factory_.createInstance()};goog.net.XmlHttp.ASSUME_NATIVE_XHR=!1;goog.net.XmlHttpDefines={};goog.net.XmlHttpDefines.ASSUME_NATIVE_XHR=!1;goog.net.XmlHttp.getOptions=function(){return goog.net.XmlHttp.factory_.getOptions()};goog.net.XmlHttp.OptionType={USE_NULL_FUNCTION:0,LOCAL_REQUEST_ERROR:1};goog.net.XmlHttp.ReadyState={UNINITIALIZED:0,LOADING:1,LOADED:2,INTERACTIVE:3,COMPLETE:4};
...
}return this.ieProgId_};goog.net.XmlHttp.setGlobalFactory(new goog.net.DefaultXmlHttpFactory);goog.string.TypedString=function(){};goog.string.Const=function(){this.stringConstValueWithSecurityContract__googStringSecurityPrivate_="";this.STRING_CONST_TYPE_MARKER__GOOG_STRING_SECURITY_PRIVATE_=goog.string.Const.TYPE_MARKER_};goog.string.Const.prototype.implementsGoogStringTypedString=!0;goog.string.Const.prototype.getTypedStringValue=function(){return this.stringConstValueWithSecurityContract__googStringSecurityPrivate_};
...
goog.Promise.setUnhandledRejectionHandler=function(a){goog.Promise.handleRejection_=a};goog.Promise.CancellationError=function(a){goog.debug.Error.call(this,a)};goog.inherits(goog.Promise.CancellationError,goog.debug.Error);goog.Promise.CancellationError.prototype.name="cancel";goog.Promise.Resolver_=function(a,b,c){this.promise=a;this.resolve=b;this.reject=c};goog.userAgent={};goog.userAgent.ASSUME_IE=!1;goog.userAgent.ASSUME_GECKO=!1;goog.userAgent.ASSUME_WEBKIT=!1;goog.userAgent.ASSUME_MOBILE_WEBKIT=!1;goog.userAgent.ASSUME_OPERA=!1;goog.userAgent.ASSUME_ANY_VERSION=!1;goog.userAgent.BROWSER_KNOWN_=goog.userAgent.ASSUME_IE||goog.userAgent.ASSUME_GECKO||goog.userAgent.ASSUME_MOBILE_WEBKIT||goog.userAgent.ASSUME_WEBKIT||goog.userAgent.ASSUME_OPERA;goog.userAgent.getUserAgentString=function(){return goog.labs.userAgent.util.getUserAgent()};
...
goog.debug.LogManager.createLogger_=function(a){var b=new goog.debug.Logger(a);if(goog.debug.Logger.ENABLE_HIERARCHY){var c=a.lastIndexOf("."),d=a.substr(0,c),c=a.substr(c+1),d=goog.debug.LogManager.getLogger(d);d.addChild_(c,b);b.setParent_(d)}return goog.debug.LogManager.loggers_[a]=b};goog.events.BrowserFeature={HAS_W3C_BUTTON:!goog.userAgent.IE||goog.userAgent.isDocumentModeOrHigher(9),HAS_W3C_EVENT_SUPPORT:!goog.userAgent.IE||goog.userAgent.isDocumentModeOrHigher(9),SET_KEY_CODE_TO_PREVENT_DEFAULT:goog.userAgent.IE&&!goog.userAgent.isVersionOrHigher("9"),HAS_NAVIGATOR_ONLINE_PROPERTY:!goog.userAgent.WEBKIT||goog.userAgent.isVersionOrHigher("528"),HAS_HTML5_NETWORK_EVENT_SUPPORT:goog.userAgent.GECKO&&goog.userAgent.isVersionOrHigher("1.9b")||goog.userAgent.IE&&goog.userAgent.isVersionOrHigher("8")||
...
goog.events.BrowserEvent.prototype.init=function(a,b){this.event_=a;var c=this.type=a.type;this.target=a.target||a.srcElement;this.currentTarget=b;var d=a.relatedTarget;d?goog.userAgent.GECKO&&(goog.reflect.canAccessProperty(d,"nodeName")||(d=null)):c==goog.events.EventType.MOUSEOVER?d=a.fromElement:c==goog.events.EventType.MOUSEOUT&&(d=a.toElement);this.relatedTarget=d;Object.defineProperties?Object.defineProperties(this,{offsetX:{configurable:!0,enumerable:!0,get:this.getOffsetX_,set:this.setOffsetX_},
offsetY:{configurable:!0,enumerable:!0,get:this.getOffsetY_,set:this.setOffsetY_}}):(this.offsetX=this.getOffsetX_(),this.offsetY=this.getOffsetY_());this.clientX=void 0!==a.clientX?a.clientX:a.pageX;this.clientY=void 0!==a.clientY?a.clientY:a.pageY;this.screenX=a.screenX||0;this.screenY=a.screenY||0;this.button=a.button;this.keyCode=a.keyCode||0;this.charCode=a.charCode||("keypress"==c?a.keyCode:0);this.ctrlKey=a.ctrlKey;this.altKey=a.altKey;this.shiftKey=a.shiftKey;this.metaKey=a.metaKey;this.platformModifierKey=
goog.userAgent.MAC?a.metaKey:a.ctrlKey;this.state=a.state;a.defaultPrevented&&this.preventDefault()};goog.events.BrowserEvent.prototype.isButton=function(a){return goog.events.BrowserFeature.HAS_W3C_BUTTON?this.event_.button==a:"click"==this.type?a==goog.events.BrowserEvent.MouseButton.LEFT:!!(this.event_.button&goog.events.BrowserEvent.IEButtonMap[a])};
...
goog.events.BrowserEvent.prototype.getOffsetX_=function(){return goog.userAgent.WEBKIT||void 0!==this.event_.offsetX?this.event_.offsetX:this.event_.layerX};goog.events.BrowserEvent.prototype.setOffsetX_=function(a){Object.defineProperties(this,{offsetX:{writable:!0,enumerable:!0,configurable:!0,value:a}})};goog.events.BrowserEvent.prototype.getOffsetY_=function(){return goog.userAgent.WEBKIT||void 0!==this.event_.offsetY?this.event_.offsetY:this.event_.layerY};
goog.events.BrowserEvent.prototype.setOffsetY_=function(a){Object.defineProperties(this,{offsetY:{writable:!0,enumerable:!0,configurable:!0,value:a}})};goog.events.LISTENER_MAP_PROP_="closure_lm_"+(1E6*Math.random()|0);goog.events.onString_="on";goog.events.onStringMap_={};goog.events.CaptureSimulationMode={OFF_AND_FAIL:0,OFF_AND_SILENT:1,ON:2};goog.events.CAPTURE_SIMULATION_MODE=2;goog.events.listenerCountEstimate_=0;
...
goog.Timer.promise=function(a,b){var c=null;return(new goog.Promise(function(d,e){c=goog.Timer.callOnce(function(){d(b)},a);c==goog.Timer.INVALID_TIMEOUT_ID_&&e(Error("Failed to schedule timer."))})).thenCatch(function(a){goog.Timer.clear(c);throw a;})};goog.uri={};goog.uri.utils={};goog.uri.utils.CharCode_={AMPERSAND:38,EQUAL:61,HASH:35,QUESTION:63};goog.uri.utils.buildFromEncodedParts=function(a,b,c,d,e,f,g){var h="";a&&(h+=a+":");c&&(h+="//",b&&(h+=b+"@"),h+=c,d&&(h+=":"+d));e&&(h+=e);f&&(h+="?"+f);g&&(h+="#"+g);return h};goog.uri.utils.splitRe_=/^(?:([^:/?#.]+):)?(?:\/\/(?:([^/?#]*)@)?([^/#?]*?)(?::([0-9]+))?(?=[/#?]|$))?([^?#]+)?(?:\?([^#]*))?(?:#(.*))?$/;
...
goog.net.XhrIo.prototype.formatMsg_=function(a){return a+" ["+this.lastMethod_+" "+this.lastUri_+" "+this.getStatus()+"]"};goog.debug.entryPointRegistry.register(function(a){goog.net.XhrIo.prototype.onReadyStateChangeEntryPoint_=a(goog.net.XhrIo.prototype.onReadyStateChangeEntryPoint_)});var fa={};
fa.session=angular.module("session",[]).factory("sessionService",["$q",function(a){return function(b){var c=null,d=null;return{signup:function(c){var f=a.defer();console.log("[sessionService] $signup called",c);b.userSignup(c,function(a){console.log("signup + login successful:",a);d=a;f.resolve(a)},function(a){console.warn("pyroSignup returned:",a);f.reject(a)});return f.promise},login:function(c){console.warn("[sessionService] $getUser called");var f=a.defer();if("object"==c)b.login(c,function(a){a?
(d=a,f.resolve(d)):(console.log("got null for returnedAccount:",a),f.reject())});else{var g=[{name:"GitHub",value:"githubAuth()",lower:"github"},{name:"Twitter",value:"twitterAuth()",lower:"twitter"},{name:"Google",value:"googleAuth()",lower:"google"}],h=goog.array.findIndex(g,function(a){return c.toLowerCase()===a.lower}),h=-1;console.error("Invalid Login Provider");f.reject({message:"Invalid login provider.",status:"INVALID_PARAMS"});g[h].value.apply(this,null)}return f.promise},logout:function(){var e=
a.defer();d=c=null;b.ref.logout(function(){e.resolve()});return e.promise},getAuth:function(){return c=b.ref.getAuth()},authPromise:function(){var c=a.defer();c.resolve(b.ref.getAuth());return c.promise},getCurrentUser:function(){var c=a.defer();null!=d?c.resolve(d):b.getUser(function(a){a?(d=a,c.resolve(d)):(console.log("got null for returnedAccount:",a),c.reject(null))});return c.promise}}}}]);goog.exportSymbol("fa.session",fa.session);
angular.module("fireadmin",[fa.session.name]).factory("$fa",["$q","sessionService",function(a,b){return function(a){a=new Fireadmin(a);return{fb:a.ref,session:b(a)}}}]);var Firebase=window.Firebase,Fireadmin=function(a,b){init();if("undefined"==typeof a||"string"!=typeof a)throw Error("Url is required to use FireAdmin");this.ref=new Firebase(a);this.fbUrl=a;this.appName=AppNameFromUrl(a);return this};
Fireadmin.prototype.createObject=function(a,b,c,d){var e=this.ref.getAuth();e&&(b.author=e.uid);b.createdAt=Date.now();this.ref.child(a).push(b,function(a){a?handleCb(d,a):handleCb(c,b)})};
Fireadmin.prototype.listByCurrentUser=function(a,b,c){var d=this.ref.getAuth();if(null!=d)this.child(a).orderByChild("author").equalTo(d.uid).on("value",function(a){handleCb(b,a.val())},function(a){handleCb(c,a)});else a={code:"INVALID_AUTH",message:"listByCurrentUser cannot load list without current user"},console.error(a.message),handleCb(c,a)};
Fireadmin.prototype.listByUid=function(a,b,c,d){this.fbRef(a).orderByChild("author").equalTo(b).on("value",function(a){handleCb(c,a.val())},function(a){handleCb(d,a)})};Fireadmin.prototype.getObjectCount=function(a,b,c){this.fbRef(a).on("value",function(a){handleCb(b,a.numChildren())},function(a){handleCb(c,a)})};Fireadmin.prototype.getUserCount=function(a,b){this.ref.child("users").on("value",function(b){handleCb(a,b.numChildren())},function(a){handleCb(b,a)})};
Fireadmin.prototype.getOnlineUserCount=function(a,b){this.ref.child("presence").on("value",function(b){console.log("There are currently"+b.numChildren()+" users online.");handleCb(a,b.numChildren())},function(a){handleCb(b,a)})};Fireadmin.prototype.sessionsBetween=function(a,b,c,d){console.log("start:"+a+" end "+b);this.ref.child("sessions").orderByChild("ended").startAt(a).endAt(b).on("value",function(a){handleCb(c,a.numChildren())},function(a){handleCb(d,a)})};
Fireadmin.prototype.sessionsSince=function(a,b,c){this.ref.child("sessions").orderByChild("ended").startAt(a).endAt(Date.now()).on("value",function(a){handleCb(b,a.numChildren())},function(a){handleCb(c,a)})};
Fireadmin.prototype.averageSessionLength=function(a,b){this.ref.child("sessions").on("value",function(b){var d=null,e=b.numChildren();b.forEach(function(a){var b=a.val();b.hasOwnProperty("ended")&&b.hasOwnProperty("began")?(d+=(b.ended-b.began)/6E4,console.log("total length is now:",d)):(console.log("removing unfinished session:",a.val()),e--,console.log("session count:",e))});console.log("totalLength:",d);b=Math.floor(d/e);console.log("average in minutes:",b);handleCb(a,b)},function(a){handleCb(b,
a)})};Fireadmin.prototype.removeUserSessions=function(a,b,c){this.ref.child("sessions").orderByChild("user").equalTo(a).on("value",function(a){var c=a.numChildren();a.forEach(function(a){a.ref().remove()});console.log(c+" Sessions sucessfully removed");handleCb(b)},function(a){handleCb(c,a)})};
Fireadmin.prototype.uploadImage=function(a,b,c){apiRequest("upload",{appName:this.appName,image:a},function(a){a.hasOwnProperty("url")?(a={url:a.url},console.log("Image data object:",a),handleCb(b,a)):handleCb(c,{code:"SERVER_ERROR"})},function(a){handleCb(c,a)})};
Fireadmin.prototype.customAuthToken=function(a,b,c){apiRequest("auth",{appName:this.appName},function(a){a.hasOwnProperty("token")?(console.log("auth request response:",a),handleCb(b,a)):handleCb(c,{code:"SERVER_ERROR"})},function(a){handleCb(c,a)})};
Fireadmin.prototype.userSignup=function(a,b,c){var d=this;if("object"==typeof a&&a.hasOwnProperty("email")){if(!a.hasOwnProperty("password")&&8>=a.password.length)return handleCb(c,{message:"A valid Password is required to signup."});d.createUser(a,function(e){null===e?(console.log("[emailSignup] User created successfully. Logging in as new user..."),d.emailAuth(a,function(a){createUserProfile(a,d.ref,function(a){handleCb(b,a)},function(a){handleCb(c,a)})},function(a){handleCb(c,a)})):(console.error("[emailSignup] Error creating user:",
e.message),handleCb(c,e))})}else if(a.hasOwnProperty("type")&&"username"==a.type)apiRequest("signup",a,function(a){console.log("request for token successful:",a);d.authWithCustomToken(a.token,function(a,e){a?handleCb(c,a):createUserProfile(e,d.ref,function(a){handleCb(b,a)},function(a){handleCb(c,a)})})},function(a){handleCb(c,a)});else if("string"==typeof a||a.hasOwnProperty("type")){if("string"==typeof a)var e=a;else a.hasOwnProperty("type")&&(e=a.type);d.authWithOAuthPopup(e,function(a,e){a?handleCb(c,
a):createUserProfile(e,d.ref,function(a){handleCb(b,a)},function(a){handleCb(c,a)})})}};Fireadmin.prototype.emailAuth=function(a,b,c){var d=this.ref;d.authWithPassword(a,function(a,f){null===a?(console.log("User ID: "+f.uid+", Provider: "+f.provider),d.setupPresence(f.uid),handleCb(b,f)):(console.error("Error authenticating user:",a),handleCb(c,a))})};
Fireadmin.prototype.authWithOAuthPopup=function(a,b,c){var d=this.ref;d.authWithOAuthPopup(a,function(a,f){null===a?(console.log("User ID: "+f.uid+", Provider: "+f.provider),d.setupPresence(f.uid),handleCb(b,f)):(console.error("Error authenticating user:",a),handleCb(c,a))})};Fireadmin.prototype.newUserFromAnonyomous=function(){};Fireadmin.prototype.newUserFromAnonyomous=function(){};function customAuthLogin(){}
Fireadmin.prototype.githubAuth=function(a,b){return this.authWithOAuthPopup("github",a,b)};Fireadmin.prototype.googleAuth=function(a,b){return this.authWithOAuthPopup("google",a,b)};Fireadmin.prototype.twitterAuth=function(a,b){return this.authWithOAuthPopup("twitter",a,b)};Fireadmin.prototype.accountByUid=function(a,b,c){this.ref.child(a).on("value",function(a){handleCb(b,a.val())},function(b){console.error("Error getting account for "+a+" : ",b);handleCb(c,b)})};
Fireadmin.prototype.accountByEmail=function(a,b,c){if(a&&"string"==typeof a)this.ref.child("users").orderByChild("email").equalTo(a).on("value",function(a){console.log("accountByEmail returned:",a.val());handleCb(b,a.val())},function(a){console.error("Error getting account by email:",a);handleCb(c,a)});else handleCb(c)};
Fireadmin.prototype.setupPresence=function(a){console.log("setupPresence called for uid:",a);var b=this.ref,c=b.child(".info/connected"),d=b.child("presence").child(a),e=b.child("sessions");b.child("users").child(a);var f=b.child("users").child(a).child("sessions");f.child("past");c.on("value",function(c){if(c.val()){b.onDisconnect();c=e.push({began:Firebase.ServerValue.TIMESTAMP,user:a});var h=c.child("ended");h.onDisconnect().set(Firebase.ServerValue.TIMESTAMP);var k=f.child("current").push(c.key());
k.onDisconnect().remove();d.set(!0);d.onDisconnect().remove();b.onAuth(function(a){a||(h.set(Firebase.ServerValue.TIMESTAMP),k.remove(),d.remove())})}})};Fireadmin.prototype.fbRef=function(a){var b=this.ref,c=Array.prototype.slice.call(arguments);c.length&&(b=b.child(pathRef(c)));return b};function pathRef(a){for(var b=0;b<a.length;b++)if("array"==typeof a[b])a[b]=pathRef(a[b]);else if("string"!==typeof a[b])throw Error("Argument "+b+" to firebaseRef is not a string: "+a[b]);return a.join("/")}
function AppNameFromUrl(a){return a.replace("https://","").replace(".firebaseio.com","")}function apiRequest(a,b,c,d){a="http://localhost:8080/"+a;console.log("apiRequest sending to "+a+" ...");goog.net.XhrIo.send(a,function(a){a.target.isComplete()&&a.target.isSuccess()?(a=a.target.getResponse(),console.log("apiRequest responded:",a),a?handleCb(c,a):(console.error("Server error"),handleCb(d,{code:"SERVER_ERROR"}))):handleCb(d,a.target.getLastError())},"POST",b)}
function createUserProfile(a,b,c,d){console.log("createUserAccount called:",arguments);var e=b.child("users").child(a.uid),f={role:10,provider:a.provider};"password"==a.provider?f.email=a.password.email:(console.log("create 3rd party linked profile:",a),goog.object.extend(f,a));b.child("users").orderByChild("email").equalTo(f.email).on("value",function(a){if(a.val())a={message:"This email has already been used to create an account",account:JSON.stringify(a.val()),status:"ACCOUNT_EXISTS"},handleCb(d,
a);else e.once("value",function(a){null==a.val()||a.hasChild("sessions")?(f.createdAt=Firebase.ServerValue.TIMESTAMP,e.setWithPriority(f,f.email,function(b){b?handleCb(d,{message:"Error creating user profile"}):(console.log("New user account created:",a.val()),handleCb(c,a.val()))})):(console.error("User account already exists",a.val()),handleCb(d,a.val()))})},function(a){handleCb(d,a)})}function handleCb(a,b){if(a&&"function"==typeof a)return b?a(b):a()}
function init(){var a=stringifyVersion(window.Firebase.SDK_VERSION),b=stringifyVersion("2.1.2");if("undefined"==typeof window.Firebase)throw Error("Firebase is required to use FireAdmin");a<b&&console.warn("Unsupported Firebase version: "+window.Firebase.SDK_VERSION+". Please upgrade to 2.1.2 or newer.")}function stringifyVersion(a){return a.replace(".","").replace(".","")};
