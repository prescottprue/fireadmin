...
goog.net.XhrIo.prototype.formatMsg_=function(a){return a+" ["+this.lastMethod_+" "+this.lastUri_+" "+this.getStatus()+"]"};goog.debug.entryPointRegistry.register(function(a){goog.net.XhrIo.prototype.onReadyStateChangeEntryPoint_=a(goog.net.XhrIo.prototype.onReadyStateChangeEntryPoint_)});var $fa={};$fa.account=angular.module("session.account",[]).factory("accountService",["$q",function(a){return{exists:!0}}]);goog.exportSymbol("$fa.account",$fa.account);$fa.auth=angular.module("auth",[$fa.account.name]);goog.exportSymbol("$fa.auth",$fa.auth);angular.module("fireadmin",[$fa.auth.name]);
var Firebase=window.Firebase,Fireadmin=function(a,b){init();if("undefined"==typeof a||"string"!=typeof a)throw Error("Url is required to use FireAdmin");this.ref=new Firebase(a);this.fbUrl=a;this.appName=AppNameFromUrl(a);return this};Fireadmin.prototype.createObject=function(a,b,c,d){var e=this.ref.getAuth();e&&(b.author=e.uid);b.createdAt=Date.now();this.ref.child(a).push(b,function(a){a?handleCb(d,a):handleCb(c,b)})};
