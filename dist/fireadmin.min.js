...
Fireadmin.prototype.authWithOAuthPopup=function(a,b,c){var d=this.ref;d.authWithOAuthPopup(a,function(a,f){null===a?(console.log("User ID: "+f.uid+", Provider: "+f.provider),d.setupPresence(f.uid),handleCb(b,f)):(console.error("Error authenticating user:",a),handleCb(c,a))})};Fireadmin.prototype.newUserFromAnonyomous=function(){};function customAuthLogin(){}Fireadmin.prototype.githubAuth=function(a,b){return this.authWithOAuthPopup("github",a,b)};
Fireadmin.prototype.googleAuth=function(a,b){return this.authWithOAuthPopup("google",a,b)};Fireadmin.prototype.twitterAuth=function(a,b){return this.authWithOAuthPopup("twitter",a,b)};Fireadmin.prototype.accountByUid=function(a,b,c){this.ref.child(a).on("value",function(a){handleCb(b,a.val())},function(b){console.error("Error getting account for "+a+" : ",b);handleCb(c,b)})};
