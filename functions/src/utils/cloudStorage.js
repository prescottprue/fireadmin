 ...
 * @param  {admin.firebase.App} app - App from which the storage File should be downloaded
 ...
 * @returns {admin.Storage.Reference} Storage reference from firebase-admin library
 */
