...
import classes from './MigrationTemplateInputs.scss'
...
export const MigrationTemplateInputs = ({ fields, inputs }) => (
  <div>
    <Button
      raised
    ...
    {fields.map((member, index, field) => (
      <ExpansionPanel key={index}>
        <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
          <Typography className={classes.title}>Input {index}</Typography>
        </ExpansionPanelSummary>
        <ExpansionPanelDetails>
...
MigrationTemplateInputs.propTypes = {
  fields: PropTypes.object.isRequired,
  inputs: PropTypes.object.isRequired
}

export default MigrationTemplateInputs
